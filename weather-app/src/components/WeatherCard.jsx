...
const WeatherCard = ({ city }) => {
  ...
  useEffect(() => {
    const loadWeather = async () => {
      ...
      try {
        ...
        if(!location){
          throw new Error("도시를 찾을 수 없습니다다");
 ...
 if(loading) {
  <div className=''>실시간 날씨 정보를 조회중입니다..</div>
 }
 if(error){
  <div className=''>도시를 찾을 수 없습니다다</div>
 }
  return (
    <> {weather && (    <div className="mt-6 flex items-center justify-around gap-4 min-w-[300px] w-auto p-4 rounded-2xl bg-white shadow text-gray-800 text-center">
